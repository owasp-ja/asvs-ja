...
| # | 説明 | レベル | #v5.0.be |
| :---: | :--- | :---: | :---: |
| **16.2.1** | 各ログのエントリには、イベント発生時のタイムラインを詳細に調査するために必要なメタデータが含まれている。 | 2 | v5.0.be-7.1.4 |
...
| **16.4.3** | 分析、検出、警告、およびエスカレーションのために、できればリモートシステムにログがセキュアに送信されている。 | 2 | v5.0.be-7.3.5 |
