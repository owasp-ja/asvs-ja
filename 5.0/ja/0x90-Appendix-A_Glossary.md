...
* **多要素認証 (Multi-factor authentication)** (MFA) - 二つ以上の単一要素を含む認証。
...
* **単一要素オーセンティケータ (Single-factor authenticator)** - ユーザが認証されることをチェックするメカニズム。あなたが知っているもの (記憶された秘密、パスワード、パスフレーズ、PIN) 、あなたであるもの (生体情報、指紋、顔スキャン) 、またはあなたが持っているもの (OTP トークン、スマートカードなどの暗号化デバイス) のいずれかである必要があります。
