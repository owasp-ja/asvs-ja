...
* **単要素オーセンティケータ (Single-factor authenticator)** - ユーザが認証されることをチェックするメカニズム。あなたが知っているもの (記憶された秘密、パスワード、パスフレーズ、PIN) 、あなたであるもの (生体情報、指紋、顔スキャン) 、またはあなたが持っているもの (OTP トークン、スマートカードなどの暗号化デバイス) のいずれかである必要があります。
