...
| :---: | :--- | :---: | :---: | :---: | :---: |
| **1.2.1** | [1.14.7 へ移動] | | | | |
| **1.2.2** | [修正] API、ミドルウェア、データ層などのバックエンドアプリケーションコンポーネント間の通信が認証され、個別のユーザアカウントを使用している。 ([C3](https://owasp.org/www-project-proactive-controls/#div-numbering)) | | ✓ | ✓ | 306 |
...
| # | 説明 | L1 | L2 | L3 | CWE |
| :---: | :--- | :---: | :---: | :---: | :---: |
| **1.9.1** | [修正] 特にコンポーネントが異なるコンテナ、システム、サイトまたはクラウドプロバイダにある場合は、アプリケーションがバックエンドコンポーネント間の通信を暗号化している。 ([C3](https://owasp.org/www-project-proactive-controls/#div-numbering)) | | ✓ | ✓ | 319 |
