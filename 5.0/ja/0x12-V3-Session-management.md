...
| :---: | :--- | :---: | :---: | :---: | :---: | :---: |
| **3.8.1** | [修正, 3.3.1 から移動] 「戻る」ボタンや下流の依拠当事者 (Relying Parties) が、認証済みセッションを再開できないように、ログアウトおよび有効期限によってユーザーのセッションが終了する。 ([C6](https://owasp.org/www-project-proactive-controls/#div-numbering)) | ✓ | ✓ | ✓ | 613 | 7.1 |
...
| **3.8.3** | [修正, 3.3.4 から移動] ユーザがすべての現在のアクティブなセッションを閲覧、および (ログインクレデンシャルを再入力して) 終了できる。 | | ✓ | ✓ | 613 | 7.1 |
