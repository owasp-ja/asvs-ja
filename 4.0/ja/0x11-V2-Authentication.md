...
| **2.2.4** | [修正] 多要素暗号化ハードウェア、または単一要素暗号化ハードウェアと OTP デバイスの組み合わせなど、ハードウェアベースのオーセンティケータと検証者にフィッシング攻撃に対するなりすまし耐性を提供するオーセンティケータが使用されている。 | | | ✓ | 308 | 5.2.5 |
...
| **2.2.9** | [追加] 多要素認証が必要とされている。つまり、アプリケーションが多要素オーセンティケータ、または単一要素オーセンティケータの組み合わせを使用している。 | | ✓ | ✓ | 308 | 4.2.1 |
